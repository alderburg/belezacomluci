                        ...
                        {coupons.map((coupon) => (
                          ...
                          >
                            {(coupon.modalImageUrl || coupon.coverImageUrl) ? (
                              ...
                              <div className="w-full aspect-square bg-gradient-to-br from-pink-100 to-purple-100 flex flex-col items-center justify-center p-4 gap-3">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-16 h-16 text-pink-400">
                                ...
                                <div className="text-center">
                                  <p className="text-base font-bold text-gray-800 mb-1">{coupon.brand}</p>
                                  {coupon.code && coupon.code.trim() !== '' && (
                                    <p className="text-sm font-mono bg-pink-200 text-pink-700 px-3 py-1 rounded-md font-semibold">
                                      {coupon.code}
                                    </p>
                                  )}
                                </div>
