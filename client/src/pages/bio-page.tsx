                        ...
                        {coupons.map((coupon) => (
                          ...
                          >
                            {(coupon.modalImageUrl || coupon.coverImageUrl) ? (
                              ...
                              <div className="w-full aspect-square bg-gray-100 flex flex-col items-center justify-center p-4">
                                ...
                                <p className="text-xs text-center text-gray-600 font-semibold mt-1">{coupon.discount}</p>
                              </div>
                            )}
                          </div>
                        ))}
