                        ...
                        {coupons.map((coupon) => (
                          ...
                          >
                            {(coupon.modalImageUrl || coupon.coverImageUrl) ? (
                              ...
                              <div className="w-full aspect-square bg-gradient-to-br from-pink-100 to-purple-100 flex flex-col items-center justify-center p-4">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-12 h-12 text-pink-400 mb-2">
                                ...
                                <p className="text-xs text-center text-pink-600 font-semibold mt-1">{coupon.discount}</p>
                              </div>
                            )}
                          </div>
                        ))}
